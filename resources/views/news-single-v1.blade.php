            ...
            <div class="container">
                ...
                <div class="float--right float--xs-none text-xs-center">
                    ...
                    <ul class="header--topbar-action nav">
                        <li><a href="login.blade.php"><i class="fa fm fa-user-o"></i>Login/Register</a></li>
                    </ul>
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="archives-v1.blade.php">Archives 1</a></li>
                                        <li><a href="archives-v2.blade.php">Archives 2</a></li>
                                        <li><a href="archives-v3.blade.php">Archives 3</a></li>
                                ...
                                <li class="dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="active"><a href="news-single-v1.blade.php">News Single 1</a></li>
                                        <li><a href="news-single-v2.blade.php">News Single 2</a></li>
                                        <li><a href="news-single-v3.blade.php">News Single 3</a></li>
                                        <li><a href="news-single-v4.blade.php">News Single 4</a></li>
                                    </ul>
                                </li>
