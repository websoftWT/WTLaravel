            ...
            <div class="container">
                ...
                <div id="headerNav" class="navbar-collapse collapse float--left">
                    ...
                    <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                        ...
                        <li class="active"><a href="national.html">National</a></li>
    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>National</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                    ...
                    <div class="row gutter--15">
                            ...
                            <div class="row gutter--15">
                                <div class="col-md-12 col-xs-6 col-xxs-12">
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/banner-01.jpg" alt=""></a>
                                            <a href="#" class="cat">Animal Planet</a>
                                            <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                ...
                                <div class="col-md-12 col-xs-6 hidden-xxs">
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/banner-02.jpg" alt=""></a>
                                            <a href="#" class="cat">Accident</a>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="post--item post--layout-1 post--title-larger">
                                <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/banner-03.jpg" alt=""></a>
                                    <a href="#" class="cat">Peace</a>
                                    <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                        ...
                        <div class="col-md-3">
                            <div class="row gutter--15">
                                <div class="col-md-12 col-xs-6 col-xxs-12">
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/banner-04.jpg" alt=""></a>
                                            <a href="#" class="cat">Discover</a>
                                            <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                ...
                                <div class="col-md-12 col-xs-6 hidden-xxs">
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/banner-05.jpg" alt=""></a>
                                            ...
                                            <div class="post--info">
                                                ...
                                                <div class="title">
                                                    <h2 class="h4"><a href="news-single-v1.html" class="btn-link">On the other hand, we denounce with righteous and deby</a></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        <div class="row">
                                    ...
                                    <ul class="nav" data-ajax-content="inner">
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/politics-01.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/politics-02.jpg" alt=""></a>
                                                    <a href="#" class="cat">Politics</a>
                                                    <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                            ...
                            <!-- Law and Justice Start -->
                            <div class="col-md-6 ptop--30 pbottom--30">
                                <!-- Post Items Title Start -->
                                <div class="post--items-title" data-ajax="tab">
                                    <h2 class="h4">Law &amp; Justice</h2>

                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_law_justice_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_law_justice_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="post--items post--items-3" data-ajax-content="outer">
                                    <ul class="nav" data-ajax-content="inner">
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/law-justice-01.jpg" alt=""></a>
                                                    <a href="#" class="cat">Law</a>
                                                    <a href="#" class="icon"><i class="fa fa-heart-o"></i></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/law-justice-02.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/law-justice-03.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/law-justice-04.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/law-justice-05.jpg" alt=""></a>
                            ...
                            <!-- Accident and Inaccident Start -->
                            <div class="col-md-12 ptop--30 pbottom--30">
                                <!-- Post Items Title Start -->
                                <div class="post--items-title" data-ajax="tab">
                                    <h2 class="h4">Accident &amp; Inaccident</h2>

                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_accident_inaccident_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_accident_inaccident_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav row" data-ajax-content="inner">
                                        <li class="col-md-12">
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/accident-inaccident-01.jpg" alt=""></a>
                                                            <a href="#" class="cat">Airlines</a>
                                                            <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-single-v1.html" class="btn-link">At vero eos et accusamus et iusto odio dignissimos uniti atque corrupti quos dolores et quas.</a></h3>
                                                            </div>
                                                        </div>
                                        ...
                                        <li class="col-md-6">
                                            ...
                                            <div class="post--item post--layout-4">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/accident-inaccident-02.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-6">
                                            ...
                                            <div class="post--item post--layout-4">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/accident-inaccident-03.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-6">
                                            ...
                                            <div class="post--item post--layout-4">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/accident-inaccident-04.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-6">
                                            ...
                                            <div class="post--item post--layout-4">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/accident-inaccident-05.jpg" alt=""></a>
                            ...
                            <!-- Accident and Inaccident End -->

                            <!-- Diplomacy Start -->
                            <div class="col-md-6 ptop--30 pbottom--30">
                                <!-- Post Items Title Start -->
                                <div class="post--items-title" data-ajax="tab">
                                    <h2 class="h4">Diplomacy</h2>

                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_diplomacy_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_diplomacy_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="post--items post--items-2" data-ajax-content="outer">
                                    <ul class="nav" data-ajax-content="inner">
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/diplomacy-01.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/diplomacy-02.jpg" alt=""></a>
                            ...
                            <div class="col-md-6 ptop--30 pbottom--30">
                                ...
                                <div class="post--items-title" data-ajax="tab">
                                    ...
                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_administration_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_administration_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="post--items post--items-2" data-ajax-content="outer">
                                    <ul class="nav" data-ajax-content="inner">
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/administration-01.jpg" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/administration-02.jpg" alt=""></a>
                    ...
                    <ul class="nav row" data-ajax-content="inner">
                        <li class="col-md-8">
                            ...
                            <div class="post--item post--layout-1 post--type-video post--title-large">
                                <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/audio-video-01.jpg" alt=""></a>
                                    <a href="#" class="cat">Beach</a>
                                    <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                            ...
                            <ul class="nav">
                                <li>
                                    ...
                                    <div class="post--item post--type-audio post--layout-3">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/audio-video-02.jpg" alt=""></a>
                                ...
                                <li>
                                    ...
                                    <div class="post--item post--type-video post--layout-3">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/audio-video-03.jpg" alt=""></a>
                                ...
                                <li>
                                    ...
                                    <div class="post--item post--type-audio post--layout-3">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/audio-video-04.jpg" alt=""></a>
                                ...
                                <li>
                                    ...
                                    <div class="post--item post--type-video post--layout-3">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/audio-video-05.jpg" alt=""></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ptop--30 pbottom--30">
                                ...
                                <div class="post--items-title" data-ajax="tab">
                                    ...
                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_crime_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_crime_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="post--items" data-ajax-content="outer">
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        <li class="col-md-4 col-xs-6 col-xxs-12">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/crime-01.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-4 col-xs-6 col-xxs-12">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/crime-02.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-4 hidden-sm hidden-xs">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/crime-03.jpg" alt=""></a>
                            ...
                            <div class="col-md-12 ptop--30 pbottom--30">
                                <!-- Post Items Title Start -->
                                <div class="post--items-title" data-ajax="tab">
                                    <h2 class="h4">Election</h2>

                                    <div class="nav">
                                        <a href="#" class="prev btn-link" data-ajax-action="load_prev_election_posts">
                                            <i class="fa fa-long-arrow-left"></i>
                                        </a>

                                        <span class="divider">/</span>

                                        <a href="#" class="next btn-link" data-ajax-action="load_next_election_posts">
                                            <i class="fa fa-long-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/election-01.jpg" alt=""></a>
                                                            <a href="#" class="cat">News</a>
                                                            <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="#" class="btn-link">At vero eos et accusamus et iusto odio dignissimos uniti atque corrupti quos dolores et quas.</a></h3>
                                                            </div>
                                                        </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/election-02.jpg" alt=""></a>
                                                            <a href="#" class="cat">News</a>
                                                            <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="news-single-v1.html" class="thumb"><img src="img/national-img/election-03.jpg" alt=""></a>
                                                            <a href="#" class="cat">News</a>
                                                            <a href="#" class="icon"><i class="fa fa-heart-o"></i></a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="post--items post--items-1" data-ajax-content="outer">
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        <li class="col-md-12">
                                            ...
                                            <div class="post--item post--layout-1 post--title-large">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/photo-gallery-01.jpg" alt=""></a>
                                                    <a href="#" class="cat">Poor</a>
                                                    <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                        ...
                                        <li class="col-md-4 col-xs-6 col-xxs-12">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/photo-gallery-02.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-4 col-xs-6 col-xxs-12">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/photo-gallery-03.jpg" alt=""></a>
                                        ...
                                        <li class="col-md-4 hidden-sm hidden-xs">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="news-single-v1.html" class="thumb"><img src="img/national-img/photo-gallery-04.jpg" alt=""></a>
